...
def inv3(matrices):
    ...
    for(unsigned int i=0; i<num_matrices; i++) {
        ...
        Q(0, 0) =  (T(1, 1)*T(2, 2)-T(2, 1)*T(1, 2)) * invDet;
        Q(1, 0) = -(T(1, 0)*T(2, 2)-T(1, 2)*T(2, 0)) * invDet;
        Q(2, 0) =  (T(1, 0)*T(2, 1)-T(2, 0)*T(1, 1)) * invDet;
        Q(0, 1) = -(T(0, 1)*T(2, 2)-T(0, 2)*T(2, 1)) * invDet;
        Q(1, 1) =  (T(0, 0)*T(2, 2)-T(0, 2)*T(2, 0)) * invDet;
        Q(2, 1) = -(T(0, 0)*T(2, 1)-T(2, 0)*T(0, 1)) * invDet;
        Q(0, 2) =  (T(0, 1)*T(1, 2)-T(0, 2)*T(1, 1)) * invDet;
        Q(1, 2) = -(T(0, 0)*T(1, 2)-T(1, 0)*T(0, 2)) * invDet;
        Q(2, 2) =  (T(0, 0)*T(1, 1)-T(1, 0)*T(0, 1)) * invDet;
    }
